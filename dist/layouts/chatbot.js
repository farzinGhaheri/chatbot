...
function displayMessage(message, className = 'bot-message') {
...
function displayStep() {
    ...
    if ((_a = step.options) === null || _a === void 0 ? void 0 : _a.length) {
...
inputBox === null || inputBox === void 0 ? void 0 : inputBox.addEventListener('keydown', (event) => {
    if (event.key === 'Enter') {
        handleInput();
    }
});
